...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "study-demo.test/envs/my-react-env"
    ]
  }
}
```
...
```
bit env set my-component study-demo.test/envs/my-react-env
```
...
```
bit new react my-workspace --aspect study-demo.test/envs/my-react-env
```
